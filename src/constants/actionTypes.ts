const actionTypes = {
  CHANGES_SAVED: 'LAYOUT/CHANGES_SAVED',
  ...
  CHANGE_UNITS: 'LAYOUT/CHANGE_UNITS',
  ...
  EDIT_LOGIC: 'OUTPUT/EDIT_LOGIC',
  SET_LAYOUT: 'LAYOUT/SET_LAYOUT',
  SET_ACTIONS: 'ACTIONS/SET_ACTIONS',
